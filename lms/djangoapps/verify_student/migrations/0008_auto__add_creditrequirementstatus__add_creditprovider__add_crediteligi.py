...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('verify_student_creditrequirementstatus', (
            ...
            ('requirement', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statuses', to=orm['verify_student.CreditRequirement'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('verify_student', ['CreditRequirementStatus'])

        # Adding model 'CreditProvider'
        db.create_table('verify_student_creditprovider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('verify_student', ['CreditProvider'])

        # Adding model 'CreditEligibility'
        db.create_table('verify_student_crediteligibility', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='eligibilities', to=orm['verify_student.CreditCourse'])),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='eligibilities', to=orm['verify_student.CreditProvider'])),
        ))
        db.send_create_signal('verify_student', ['CreditEligibility'])

        # Adding unique constraint on 'CreditEligibility', fields ['username', 'course']
        db.create_unique('verify_student_crediteligibility', ['username', 'course_id'])

        # Adding model 'CreditRequirement'
        db.create_table('verify_student_creditrequirement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credit_requirements', to=orm['verify_student.CreditCourse'])),
        ...
        db.send_create_signal('verify_student', ['CreditRequirement'])

        # Adding unique constraint on 'CreditRequirement', fields ['namespace', 'name', 'course']
        db.create_unique('verify_student_creditrequirement', ['namespace', 'name', 'course_id'])

        # Adding model 'CreditCourse'
        db.create_table('verify_student_creditcourse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_key', self.gf('xmodule_django.models.CourseKeyField')(unique=True, max_length=255, db_index=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('verify_student', ['CreditCourse'])


    def backwards(self, orm):
        # Removing unique constraint on 'CreditRequirement', fields ['namespace', 'name', 'course']
        db.delete_unique('verify_student_creditrequirement', ['namespace', 'name', 'course_id'])

        # Removing unique constraint on 'CreditEligibility', fields ['username', 'course']
        db.delete_unique('verify_student_crediteligibility', ['username', 'course_id'])

        # Deleting model 'CreditRequirementStatus'
        db.delete_table('verify_student_creditrequirementstatus')

        # Deleting model 'CreditProvider'
        db.delete_table('verify_student_creditprovider')

        # Deleting model 'CreditEligibility'
        db.delete_table('verify_student_crediteligibility')

        # Deleting model 'CreditRequirement'
        db.delete_table('verify_student_creditrequirement')

        # Deleting model 'CreditCourse'
        db.delete_table('verify_student_creditcourse')
    ...
    models = {
        ...
        'verify_student.creditcourse': {
            'Meta': {'object_name': 'CreditCourse'},
            'course_key': ('xmodule_django.models.CourseKeyField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'verify_student.crediteligibility': {
            'Meta': {'unique_together': "(('username', 'course'),)", 'object_name': 'CreditEligibility'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'eligibilities'", 'to': "orm['verify_student.CreditCourse']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'eligibilities'", 'to': "orm['verify_student.CreditProvider']"}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
        },
        'verify_student.creditprovider': {
        ...
        'verify_student.creditrequirement': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_requirements'", 'to': "orm['verify_student.CreditCourse']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
        ...
        'verify_student.creditrequirementstatus': {
            'Meta': {'object_name': 'CreditRequirementStatus'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'requirement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'statuses'", 'to': "orm['verify_student.CreditRequirement']"}),
        ...
        'verify_student.softwaresecurephotoverification': {
            ...
            'receipt_id': ('django.db.models.fields.CharField', [], {'default': "'c0c36a61-8e9b-4f28-85f5-4262bdab9eb9'", 'max_length': '255', 'db_index': 'True'}),
